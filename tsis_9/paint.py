...
try :
    while True :
        ...
        if e.type == pygame.KEYDOWN:
            ...
            elif e.key == pygame.K_r:  # right triangle
                pygame.draw.polygon(screen, color,
                                    ((spot[0], spot[1]), (spot[0], spot[1] + 100), (spot[0] - 100, spot[1] + 100)))
            elif e.key == pygame.K_t:  # equilateral triangle
                pygame.draw.polygon(screen, color,
                                    ((spot[0], spot[1]), (spot[0] + 50, spot[1] + 100), (spot[0] - 50, spot[1] + 100)))
            elif e.key == pygame.K_y:  # rhombus
                pygame.draw.polygon(screen, color,
                                    ((spot[0], spot[1]), (spot[0] + 50, spot[1] + 100), (spot[0] - 50, spot[1] + 100)))
                pygame.draw.polygon(screen, color, (
                (spot[0], spot[1] + 200), (spot[0] + 50, spot[1] + 100), (spot[0] - 50, spot[1] + 100)))
